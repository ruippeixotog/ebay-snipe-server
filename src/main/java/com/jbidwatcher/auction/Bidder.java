...
public interface Bidder {
  JHTML.Form getBidForm(CookieJar cj, AuctionInfo inEntry, Currency inCurr) throws com.jbidwatcher.auction.BadBidException;

  int buy(AuctionInfo ae, int quantity);
   ...
   */
  int bid(AuctionInfo inEntry, Currency inBid, int inQuantity);

  int placeFinalBid(CookieJar cj, JHTML.Form bidForm, AuctionInfo inEntry, Currency inBid, int inQuantity);
}
