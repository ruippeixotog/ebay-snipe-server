...
//    }
  ...
  private String checkForWarning(AuctionInfo inEntry, JHTML htmlDocument) throws UnsupportedEncodingException {
  ...
  private String getBidInfoURL(AuctionInfo inEntry, Currency inCurr) {
  ...
  private CookieJar checkSignin(AuctionInfo inEntry, JHTML htmlDocument) {
  ...
  private BidFormReturn getBidFormInternal(String pageName, AuctionInfo inEntry, CookieJar cj) throws IOException {
  ...
  public int buy(AuctionInfo ae, int quantity) {
  ...
  public int bid(AuctionInfo inEntry, Currency inBid, int inQuantity) {
  ...
  public int placeFinalBid(CookieJar cj, JHTML.Form bidForm, AuctionInfo inEntry, Currency inBid, int inQuantity) {
    String bidRequest = Externalized.getString("ebayServer.protocol") + T.s("ebayServer.bidHost") + Externalized.getString("ebayServer.V3file");
  ...
  private int handlePostBidBuyPage(CookieJar cj, StringBuffer loadedPage, JHTML.Form bidForm, AuctionInfo inEntry) {
    JHTML htmlDocument = new JHTML(loadedPage);
