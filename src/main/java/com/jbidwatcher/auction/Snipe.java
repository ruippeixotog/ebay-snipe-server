...
public class Snipe {
  ...
  private int doSnipe() {
    ...
    int rval = mBidder.placeFinalBid(mCJ, mBidForm, mEntry.getAuction(), mEntry.getSnipeAmount(), mEntry.getSnipeQuantity());
  ...
  private int preSnipe() {
    ...
    try {
      ...
      mBidForm = mBidder.getBidForm(mCJ, mEntry.getAuction(), mEntry.getSnipeAmount());
